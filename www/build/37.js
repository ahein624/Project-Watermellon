...
var InstagramCommentPage = (function () {
    ...
    InstagramCommentPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-instagram-comment',template:/*ion-inline-start:"/Volumes/TUBBY/Dev/Project-Watermellon/src/pages/ready-app/instagram/instagram-comment/instagram-comment.html"*/'<!--\n  Generated template for the InstagramCommentPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>instagram-comment</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-spinner class="indicator" [ngClass]="spnState"></ion-spinner>\n  <ion-list>\n  <ion-item *ngFor="let item of list">\n    <ion-avatar item-start>\n      <img src="{{item.from.profile_picture}}">\n    </ion-avatar>\n    <h2>{{item.from.username}}</h2>\n    <p>{{item.text}}</p>\n  </ion-item>\n </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Volumes/TUBBY/Dev/Project-Watermellon/src/pages/ready-app/instagram/instagram-comment/instagram-comment.html"*/,
        }),
