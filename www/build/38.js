...
var FacebookCommentPage = (function () {
    ...
    FacebookCommentPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-facebook-comment',template:/*ion-inline-start:"/Volumes/TUBBY/Dev/Project-Watermellon/src/pages/ready-app/facebook/facebook-comment/facebook-comment.html"*/'<!--\n  Generated template for the FacebookCommentPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>facebook-comment</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n<ion-spinner class="indicator" [ngClass]="spnState"></ion-spinner>\n<ion-list>\n  <ion-item *ngFor="let item of list">\n    <ion-avatar item-start>\n<!--       <img src="http://graph.facebook.com/{{item.from.id}}/picture?type=square"> -->\n    </ion-avatar>\n<!--     <h2>{{item.from.name}}</h2> -->\n    <p>{{item.message}}</p>\n  </ion-item>\n</ion-list>\n  <ion-infinite-scroll (ionInfinite)="loadMore($event)">\n    <ion-infinite-scroll-content></ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n'/*ion-inline-end:"/Volumes/TUBBY/Dev/Project-Watermellon/src/pages/ready-app/facebook/facebook-comment/facebook-comment.html"*/,
        }),
