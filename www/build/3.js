...
var InfoGalleryComponent = (function () {
    ...
    InfoGalleryComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'info-gallery',template:/*ion-inline-start:"/Volumes/TUBBY/Dev/Project-Watermellon/src/components/gallery/info-gallery/info-gallery.html"*/'<ion-row class="pdl-5 pdr-5">\n<ion-col col-6 *ngFor="let item of data" class="mgb-10 ani-right-to-left">\n<div class="wrapper-info-gallery">\n	<img src="{{item.path}}" alt="" (click)="onCallbackEvent(\'onClick\',item, $event)">\n</div>\n\n<div class="text-info">\n	<h4 class="title fs-13 fw-500 text-ellipsis mgt-5 mgb-0" [innerHTML]="item.title"></h4>\n</div>\n\n</ion-col>\n</ion-row>\n'/*ion-inline-end:"/Volumes/TUBBY/Dev/Project-Watermellon/src/components/gallery/info-gallery/info-gallery.html"*/
        }),
...
var GridGalleryComponent = (function () {
    ...
    GridGalleryComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'grid-gallery',template:/*ion-inline-start:"/Volumes/TUBBY/Dev/Project-Watermellon/src/components/gallery/grid-gallery/grid-gallery.html"*/'<div>\n	<ion-row class="">\n		<ion-col col-3 class="pd-0 ani-scale" *ngFor="let item of data">\n			<div class="wrapper-grid-gallery">\n				<img src="{{item.path}}" alt="" (click)="onCallbackEvent(\'onClick\',item, $event)">\n		 	</div>\n		</ion-col>\n	</ion-row>\n</div>'/*ion-inline-end:"/Volumes/TUBBY/Dev/Project-Watermellon/src/components/gallery/grid-gallery/grid-gallery.html"*/
        }),
        __metadata("design:paramtypes", [])
...
var MasonryGalleryComponent = (function () {
    ...
    MasonryGalleryComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'masonry-gallery',template:/*ion-inline-start:"/Volumes/TUBBY/Dev/Project-Watermellon/src/components/gallery/masonry-gallery/masonry-gallery.html"*/' <masonry>\n  <masonry-brick class="brick" *ngFor="let item of data">  \n 	<img src="{{item.path}}" (click)="onCallbackEvent(\'onClick\',item, $event)">\n  </masonry-brick>\n</masonry>\n'/*ion-inline-end:"/Volumes/TUBBY/Dev/Project-Watermellon/src/components/gallery/masonry-gallery/masonry-gallery.html"*/
        }),
        __metadata("design:paramtypes", [])
