...
var UnsplashFavoritePage = (function () {
    ...
    UnsplashFavoritePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-unsplash-favorite',template:/*ion-inline-start:"/Volumes/TUBBY/Dev/Project-Watermellon/src/pages/ready-app/unsplash/unsplash-favorite/unsplash-favorite.html"*/'<!--\n  Generated template for the UnsplashFavoriestPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Favorite</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only small class="grey-2 bdra-50 text-black" (click)="removeAll()">\n        <ion-icon class="fs-18" name="md-trash"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <info-gallery [data]="data" [events]="events"></info-gallery>\n</ion-content>\n'/*ion-inline-end:"/Volumes/TUBBY/Dev/Project-Watermellon/src/pages/ready-app/unsplash/unsplash-favorite/unsplash-favorite.html"*/,
        }),
